...
if (!function_exists('group_wa')) {
    /**
    * ID grup wa buat kirim notif.
    *
    * Cara dapet ID grupnya:
    * 1. Buat dulu grup, terus invite wa notif ke dalam grup.
    * 2. Wa notif chat dulu sekali di dalam grup.
    * 3. Cek di dashboard wablas ID grupnya.
    *
    * @param string $type
    *
    * @throws \Exception
    ...
    * @return string
    */
    function group_wa($type)
    {
        $group_id = [
            'testing' => '120363142854335328',
            'sponsorship' => '120363144268942848',
            'permasalahan_produksi' => '120363160583952718',
            'customer_care' => '120363275366573708',
        ];

        if (!isset($group_id[$type])) {
            throw new \Exception("Gak ada ID grup wa-nya ($type). Cek list grup wa di <strong>application/helpers/str_helper.php</strong> fungsi <strong>group_wa</strong>.");
        }

        return $group_id[$type];
    }
}
